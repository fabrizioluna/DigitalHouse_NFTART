...
const popUpCloseLogin = 
    document
        .getElementById('popUp__CloseLogin')
        .addEventListener('click', ()=> {
            closePopUp();
});
...
const popUpCloseRegister = 
    document
        .getElementById('popUp__CloseRegister')
        .addEventListener('click', ()=> {
            closePopUp();
});

const popUpChangeScreen = 
    document
...
const popUpBackScreen = 
    document
        .getElementById('popUp__BackRegister')
        .addEventListener('click', () => {
...
const popUpBackdropLogin = 
    document
        .getElementById('popUpBackdropLogin');

const popUpContentLogin = 
    document
        .getElementById('popUpContentLogin');

const popUpBackdropRegister = 
    document
        .getElementById('popUpBackdropRegister');
  
const popUpContentRegister = 
    document
        .getElementById('popUpContentRegister');
